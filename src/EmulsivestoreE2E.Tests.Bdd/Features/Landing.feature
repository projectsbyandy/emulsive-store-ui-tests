Feature: Emulsive Store Landing Page
    As a photographer
    I want to read information about Emulsive Store
    So that I understand what the store sells

Background:
    Given am on the Emulsive Store Landing page
